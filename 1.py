...
keywords = [
  "historical mysteries",
    ...
    "unexplained history secrets",
    "world’s greatest mysteries"
    "most mysterious places in history",
    "top 10 lost treasures never found",
    "secrets of ancient civilizations",
    "strange archaeological finds",
    "mysterious ancient artifacts",
    "history’s biggest unsolved mysteries",
    "hidden treasure stories in history",
    "unexplained events in history",
    "real life lost treasure stories",
    "ancient history mysteries revealed"
]
